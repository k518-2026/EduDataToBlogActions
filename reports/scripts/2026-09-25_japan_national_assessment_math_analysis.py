"""
【全国学力調査】小・中学校における算数・数学の平均正答率と意識推移
オープンデータ統計分析・可視化再現スクリプト
データ提供元: 文部科学省・国立教育政策研究所 (https://www.nier.go.jp/kaihatsu/zenkokugakuryoku.html)
"""
import pandas as pd
import numpy as np
...
print("==================================================")
nc_pairs = [('勉強が好き肯定率', '端末活用率'), ('将来役立つ肯定率', '端末活用率'), ('平均正答率', '端末活用率'), ('平均正答率', '勉強が好き肯定率'), ('平均正答率', '将来役立つ肯定率'), ('勉強が好き肯定率', '将来役立つ肯定率')]
...
plt.title("【全国学力調査】小・中学校における算数・数学の平均正答率と意識推移", fontsize=13, fontweight="bold", pad=12)
