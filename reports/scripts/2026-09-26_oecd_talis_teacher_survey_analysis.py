"""
【OECD TALIS】中学校教員の指導自己効力感とICT・理数探究実践の国際比較
オープンデータ統計分析・可視化再現スクリプト
データ提供元: OECD（経済協力開発機構）TALIS国際指導環境調査 (https://www.oecd.org/education/talis/)
"""
import pandas as pd
import numpy as np
...
# ==============================================================================
metrics = ['ICT活用指導肯定率', '批判的思考促進自己効力感', '教員間協働指導実施率']
print("\n==================================================")
print("📊 主要指標の記述統計量")
print("==================================================")
for m in metrics:
...
print("==================================================")
nc_pairs = [('ICT活用指導肯定率', '教員間協働指導実施率'), ('ICT活用指導肯定率', '批判的思考促進自己効力感'), ('批判的思考促進自己効力感', '教員間協働指導実施率')]
...
metric = "ICT活用指導肯定率"
ranked = df.groupby("国・地域")[metric].agg(["mean", "std", "count"]).sort_values(by="mean", ascending=True)
...
plt.title("【OECD TALIS】中学校教員の指導自己効力感とICT・理数探究実践の国際比較", fontsize=13, fontweight="bold", pad=12)
