"""
【OECD PISA】主要国の数学的リテラシー得点とデジタル活用の比較
オープンデータ統計分析・可視化再現スクリプト
データ提供元: OECD（経済協力開発機構） (https://www.oecd.org/pisa/)
"""
import pandas as pd
import numpy as np
...
print("==================================================")
nc_pairs = [('男女得点差', '数学得点'), ('数学得点', '男子得点'), ('数学得点', '女子得点'), ('男子得点', '女子得点')]
...
plt.title("【OECD PISA】主要国の数学的リテラシー得点とデジタル活用の比較", fontsize=13, fontweight="bold", pad=12)
