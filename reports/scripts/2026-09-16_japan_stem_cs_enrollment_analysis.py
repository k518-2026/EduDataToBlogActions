"""
【学校基本調査】情報科学・工学系学科入学者数と女子比率の推移
オープンデータ統計分析・可視化再現スクリプト
データ提供元: 文部科学省 (https://www.mext.go.jp/b_menu/toukei/chousa01/kihon/1267995.htm)
"""
import pandas as pd
import numpy as np
...
plt.title("【学校基本調査】情報科学・工学系学科入学者数と女子比率の推移", fontsize=13, fontweight="bold", pad=12)
